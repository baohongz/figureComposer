...
module.exports = {
  enable: function(instance) {
    ...
    if (!styleEl) {
      ...
      style.textContent = '.svg-pan-zoom-control { cursor: pointer; fill: black; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }'
...
//    zoomInShape.setAttribute('class', 'svg-pan-zoom-control-element'); 
    zoomInShape.setAttribute('style', 'fill:black'); // Baohong
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControlShape1.setAttribute('style', 'fill:black');
    ...
    resetPanZoomControlShape2.setAttribute('style', 'fill:black');
...
, _createZoomOut: function(instance){
    ...
    zoomOutShape.setAttribute('style', 'fill:black');
